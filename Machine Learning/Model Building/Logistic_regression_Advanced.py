# -*- coding: utf-8 -*-
"""
Created on Sat Feb  7 15:46:35 2026
...
for threshold in thresholds:
    ...
    pred_class = (y_pred_prob >= threshold) * 1 # Multiply by 1 is to convert into 0,1, otherwise values will be boolean
...
plt.title(f"Finding the Optimal Threshold for Classification Model \n Max F1: {round(max_f1,2)}  (Threshold Probability: = {round(thresholds[max_f1_idx],2)}")
...
optimal_threshold = 0.44 # as per above exercise
