# -*- coding: utf-8 -*-
"""
Created on Tue Feb 10 06:16:26 2026
...
# apriori accepts only list of lists and not df like scikit learn

transactions_list = []

for index, row in alcohol_transactions.iterrows(): # reads data every row
...
apriori_rules = list(apriori_rules) # convert generator object to a list
